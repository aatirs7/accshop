...
const sections = [
  ...
  },
  {
    ...
    body: "You're purchasing ownership of an established TikTok account with TikTok Shop Affiliate access, sourced from our vetted supplier network. Once credentials are delivered, the account is yours: change the password, recovery email, and every other detail once TikTok's 48-hour security hold clears.",
  },
  {
    title: "Payment",

const benefits = [
  ...
  },
  {
    ...
    body: "Change the login, email, and every recovery detail once TikTok's 48-hour security hold clears. It's entirely yours.",
  },
  {
    icon: "🛍️",
  ...
  },
  {
    ...
    body: "Every account is covered for 14 days, with a live countdown in your dashboard.",
  },
];

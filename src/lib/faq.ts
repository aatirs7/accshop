...
export const FAQS: FaqEntry[] = [
  ...
  },
  {
    ...
    answer:
      "Yes, 100%. You can change the login, email, password, and every recovery detail once TikTok's 48-hour security hold clears. It's entirely yours after delivery.",
    keywords: ["own", "ownership", "mine", "change", "login", "email", "password", "recovery", "control"],
  },
  {
    question: "How are login credentials delivered?",
    answer:
      "By email. Once your payment is confirmed and the account is ready, we email your username, password, and linked email. TikTok holds recovery detail changes for 48 hours after login for security, so change the password and recovery email once that hold clears and save them somewhere safe.",
